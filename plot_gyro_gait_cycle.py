...
plt.plot(pct_gait_cycle, cycle["Right_Thigh_Gx"], label="Gx", color="green")
plt.plot(pct_gait_cycle, cycle["Right_Thigh_Gy"], label="Gy", color="red")
plt.plot(pct_gait_cycle, cycle["Right_Thigh_Gz"], label="Gz", color="blue")
plt.title("Right Thigh Gyroscope Over One Gait Cycle - AB185 Circuit 003")
plt.xlabel("gait (%)")
plt.ylabel("Gyroscope (deg/s)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("gyro_gait_cycle_plot.png")
print("Plot successfully saved to gyro_gait_cycle_plot.png")
