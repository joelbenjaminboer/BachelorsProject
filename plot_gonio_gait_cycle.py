...
plt.plot(pct_gait_cycle, cycle["Right_Knee"], label="Knee", color="green")
plt.title("Right Goniometer Over One Gait Cycle - AB185 Circuit 003")
plt.xlabel("gait (%)")
plt.ylabel("Gonio (deg)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("gonio_gait_cycle_plot.png")
print("Plot successfully saved to gonio_gait_cycle_plot.png")
